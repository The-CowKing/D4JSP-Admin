...
export function AuthProvider({ children }) {
  ...
  const signInGoogle = async () => {
    // Land back on the page that initiated the sign-in. Without this, NEXT_PUBLIC_SITE_URL
    // is baked at build-time to https://trade.d4jsp.org and the admin sign-in always returns
    // to the main trade app root instead of /admin-panel/.
    const here =
